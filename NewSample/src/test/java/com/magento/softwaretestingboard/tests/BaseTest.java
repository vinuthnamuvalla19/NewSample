...
public class BaseTest {
    ...
    public BaseTest() {
        ...
        System.out.println("login Email : "+getRandomEmail);
        getRandomPassword = CredentialsGenerator.getRandomPassword();
        System.out.println("Login Password : "+getRandomPassword);
        getRandomFirstName = CredentialsGenerator.generateRandomFirstName(5);
        System.out.println("Customer First name : "+getRandomFirstName);
        getRandomLastName = CredentialsGenerator.generateRandomLastName(7);
        System.out.println("Cuctomer Last name : "+getRandomLastName);
    }
